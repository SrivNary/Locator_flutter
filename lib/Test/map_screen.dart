...
import 'package:num_navigation/Test/google_map_methods.dart';
      ...
      if(dataSnap.snapshot.value != null)
      {
        if((dataSnap.snapshot.value as Map)["blockStatus"] == "no")
        {
          ...
          });
          {
            ...
            associateMethods.showSnackBarMsg("you are blocked. Contact admin: oeurndany@gmail.com", context);
          }
        }
      }
      else
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ///google map
          GoogleMap(
              padding: EdgeInsets.only(top: 26, bottom: buttonMapPadding),
          ...
          Positioned(
            ...
            child: AnimatedSize(
              ...
              duration: Duration(milliseconds: 122),
              child: Container(
                            ...
                            children: [
                              ...
                              Text(
                                Provider.of<AppInfo>(context, listen:  true).pickUpLocation == null
                                    ? "please wait..."
                                    : (Provider.of<AppInfo>(context, listen:  false).pickUpLocation!.placeName!).substring(0, 30)+"...",
